...
<body>
<!-- <link rel="stylesheet" href="css/dayeong.css"> -->
<div class="header" >
	<div class="logo">
	<a href="index.jsp">
	<img src="img/logo.png" alt="index.html" style="float:left; height:95px; top:10px;  margin-left: 18%; ">
	</a>
	</div>
